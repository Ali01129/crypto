...
import FoundersVerifiedData from "../FoundersVerifiedData/FoundersVerifiedData";



const FoundersVerified = () => {
      ...
      <div className="topSideVehicles">
        ...
        <div className="vehicleAdminMain">
          <div className="topTextEditAdmVehic">
            You Can See Detail About Verified Founders
          </div>
...
export default FoundersVerified;
