...
<AdminHeader rightHeader={rightHeader}/>
      <div className="topSideVehicles">
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">CountryCode:</label>
          <input    className="inputSearchVehic" type="text" value={location} onChange={(e) => setLocation(e.target.value)} />
        </div>
        {errors.location && <p className="error">⚠ {errors.location}</p>}
...
<div className="xyz">
          <label className="topTextEditAdmVehic2">Instagram Link:</label>
        ...
        <div className="xyz">
        <label className="topTextEditAdmVehic2">Do you want to make this event Featured?</label>
        <div className="like">
          <div>
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Date From:</label>
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Date To:</label>
          <input    className="inputSearchVehic" type="text" value={deadline} onChange={(e) => setDeadline(e.target.value)} />
        </div>
        {errors.deadline && <p className="error">⚠ {errors.deadline}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Time Interval:</label>
          <input    className="inputSearchVehic" type="text" value={deadline} onChange={(e) => setDeadline(e.target.value)} />
        </div>
        {errors.deadline && <p className="error">⚠ {errors.deadline}</p>}

        {/*Hashtags*/}
        <button className="btnSearchVehicle hh" type="submit">Upload Event</button>
        {uploading && (
