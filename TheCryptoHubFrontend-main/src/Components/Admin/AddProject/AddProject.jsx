...
<AdminHeader rightHeader={rightHeader}/>
      <div className="topSideVehicles">
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Chain:</label>
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Private Project:</label>
          <select value={privatee} onChange={(e) => setPrivatee(e.target.value)}>
          <option value="Select">Select</option>
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Sort By:</label>
          <select value={sortbyy} onChange={(e) => setSortByy(e.target.value)}>
          <option value="Select">Select</option>
        ...
        {errors.sortbyy && <p className="error">⚠ {errors.sortbyy}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">TGE:</label>
          <input    className="inputSearchVehic" type="text" value={tge} onChange={(e) => setTge(e.target.value)} />
        </div>
        {errors.tge && <p className="error">⚠ {errors.tge}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Valuation Cap:</label>
          <input    className="inputSearchVehic" type="text" value={valuationcap} onChange={(e) => setValuationCap(e.target.value)} />
        </div>
        {errors.valuationcap && <p className="error">⚠ {errors.valuationcap}</p>}

        <div className="xyz">
          <label className="topTextEditAdmVehic2">Special:</label>
          <input    className="xyz2" type="checkbox" checked={special} onChange={(e) => setSpecial(e.target.checked)} />
        </div>
        {special && (
          <>
        <div className="xyz">
        <label className="topTextEditAdmVehic2">Discounted Valuation Cap:</label>
          <input    className="inputSearchVehic" type="text" value={discountedValuationCap} onChange={(e) => setDiscountedValuationCap(e.target.value)} />
        </div>
        {errors.discountedValuationCap && <p className="error">⚠ {errors.discountedValuationCap}</p>}

<div className="xyz">
<label className="topTextEditAdmVehic2">Discount:</label>
<input    className="inputSearchVehic" type="text" value={discount} onChange={(e) => setDiscount(e.target.value)} />
</div>
{errors.discount && <p className="error">⚠ {errors.discount}</p>}
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Stage:</label>
        ...
        {errors.stage && <p className="error">⚠ {errors.stage}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Location:</label>
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Investor Amount:</label>
          <input    className="inputSearchVehic" type="text" value={investoramount} onChange={(e) => setInvestorAmount(e.target.value)} />
        </div>
        {errors.investoramount && <p className="error">⚠ {errors.investoramount}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Raised Money:</label>
          <input    className="inputSearchVehic" type="text" value={raisedmoney} onChange={(e) => setRaisedMoney(e.target.value)} />
        </div>
        {errors.raisedmoney && <p className="error">⚠ {errors.raisedmoney}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Minimum Investment:</label>
          <input    className="inputSearchVehic" type="text" value={mininvestment} onChange={(e) => setMinInvestment(e.target.value)} />
        </div>
        {errors.mininvestment && <p className="error">⚠ {errors.mininvestment}</p>}
        ...
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Maximum Investment:</label>
          <input    className="inputSearchVehic" type="text" value={maxInvestment} onChange={(e) => setMaxInvestment(e.target.value)} />
        </div>
        {errors.maxInvestment && <p className="error">⚠ {errors.maxInvestment}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Funding Goal:</label>
          <input    className="inputSearchVehic" type="text" value={fundingGoal} onChange={(e) => setFundingGoal(e.target.value)} />
        </div>
        {errors.fundingGoal && <p className="error">⚠ {errors.fundingGoal}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">TGE Date:</label>
          <input    className="inputSearchVehic" type="text" value={tgeDate} onChange={(e) => setTgeDate(e.target.value)} />
        </div>
        {errors.tgeDate && <p className="error">⚠ {errors.tgeDate}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Allocation:</label>
          <input    className="inputSearchVehic" type="text" value={allocation} onChange={(e) => setAllocation(e.target.value)} />
        </div>
        {errors.allocation && <p className="error">⚠ {errors.allocation}</p>}
        <div className="xyz">
      ...
      {videoRequired === "yes" && (
        <div>
          <div className="xyz">
  <label className="topTextEditAdmVehic2">Want to Upload from pc or paste online URL?</label>
  <div className="like">
    <div>
      <input
        type="radio"
        ...
        name="videoChoice"
        value="upload"
        checked={videoChoice === "upload"}
        onChange={() => handleVideoChoice("upload")}
      />
      <label htmlFor="videoUpload">Upload</label>
    </div>
    <div>
      <input
        type="radio"
        ...
        name="videoChoice"
        value="url"
        checked={videoChoice === "url"}
        onChange={() => handleVideoChoice("url")}
      />
      <label htmlFor="videoUrl">Paste URL</label>
    </div>
  </div>
</div>
...
{videoChoice === "upload" ? (
  <>
  <div className="xyz">
    <label className="topTextEditAdmVehic2">Upload Video:</label>
    <input type="file" accept="video/*" onChange={(e) => handleFileChange(e, setVideoFile)} />
  </div>
  ...
  <>
  <div className="xyz">
    <label className="topTextEditAdmVehic2">Video URL:</label>
    <input
      className="inputSearchVehic"
      type="text"
      value={videoUrl}
  ...
  {errors.videoUrl && <p className="error">⚠ {errors.videoUrl}</p>}
      ...
      <div className="xyz">
        <label className="topTextEditAdmVehic2">How many pictures you want to add?</label>
        <input
          className="inputSearchVehic"
          type="number"
          value={numPictures}
          onChange={(e) => setNumPictures(e.target.value)}
        />
      </div>
      {pictureDivs}
      ...
      <div className="xyz">
        <label className="topTextEditAdmVehic2 stat">
          How many statements you want to add for Highlights?
        </label>
        <input
        className="inputSearchVehic"
          type="number"
          value={numHighlightsStatements}
          onChange={(e) => handleNumStatementsChange("highlights", e)}
        />
      </div>
      {renderStatementInputs("highlights", numHighlightsStatements)}
      {errors.highlightsStatements && <p className="error">⚠ {errors.highlightsStatements}</p>}
      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for Utility?
        </label>
        <input
        className="inputSearchVehic"
          type="number"
          value={numUtilityStatements}
          onChange={(e) => handleNumStatementsChange("utility", e)}
        />
      </div>
      {renderStatementInputs("utility", numUtilityStatements)}
      {errors.utilityStatements && <p className="error">⚠ {errors.utilityStatements}</p>}


      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for USP?
        </label>
        <input
        className="inputSearchVehic"
          type="number"
          value={numUspStatements}
          onChange={(e) => handleNumStatementsChange("usp", e)}
        />
      </div>
      {renderStatementInputs("usp", numUspStatements)}
      {errors.uspStatements && <p className="error">⚠ {errors.uspStatements}</p>}
      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for roadMap?
        </label>
        <input
        className="inputSearchVehic"
          type="number"
          value={numRoadMapStatements}
          onChange={(e) => handleNumStatementsChange("roadMap", e)}
        />
      </div>
      {renderStatementInputs("roadMap", numRoadMapStatements)}
      {errors.roadMapStatements && <p className="error">⚠ {errors.roadMapStatements}</p>}
      ...
      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for revenueStream?
        </label>
        <input
        className="inputSearchVehic"
          type="number"
          value={numRevenueStreamStatements}
          onChange={(e) => handleNumStatementsChange("revenueStream", e)}
        />
      </div>
      {renderStatementInputs("revenueStream", numRevenueStreamStatements)}
      {errors.revenueStreamStatements && <p className="error">⚠ {errors.revenueStreamStatements}</p>}
      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for technology?
        </label>
        <input
        className="inputSearchVehic"
          type="number"
          value={numTechnologyStatements}
          onChange={(e) => handleNumStatementsChange("technology", e)}
        />
      </div>
      {renderStatementInputs("technology", numTechnologyStatements)}
      {errors.technologyStatements && <p className="error">⚠ {errors.technologyStatements}</p>}
      ...
      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for marketingStrategy?
        </label>
        <input
          type="number"
          className="inputSearchVehic"
          value={numMarketingStrategyStatements}
          onChange={(e) => handleNumStatementsChange("marketingStrategy", e)}
        />
      </div>
      {renderStatementInputs("marketingStrategy", numMarketingStrategyStatements)}
      {errors.marketingStrategyStatements && <p className="error">⚠ {errors.marketingStrategyStatements}</p>}
      <div className="xyz">
        <label className="topTextEditAdmVehic2">
          How many statements you want to add for tokenomics?
        </label>
        <input
          type="number"
          className="inputSearchVehic"
          value={numTokenomicStatements}
          onChange={(e) => handleNumStatementsChange("tokenomic", e)}
        />
      </div>
      {renderStatementInputs("tokenomic", numTokenomicStatements)}
      {errors.tokenomicStatements && <p className="error">⚠ {errors.tokenomicStatements}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Deadline:</label>
          <input    className="inputSearchVehic" type="text" value={deadline} onChange={(e) => setDeadline(e.target.value)} />
        </div>
        {errors.deadline && <p className="error">⚠ {errors.deadline}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Security Type:</label>
          <input    className="inputSearchVehic" type="text" value={securityType} onChange={(e) => setSecurityType(e.target.value)} />
        </div>
        {errors.securityType && <p className="error">⚠ {errors.securityType}</p>}
        <div className="xyz">
          <label className="topTextEditAdmVehic2">Nominee Lead:</label>
          <textarea  value={nomineeLead} onChange={(e) => setNomineeLead(e.target.value)} />
        </div>
        {errors.nomineeLead && <p className="error">⚠ {errors.nomineeLead}</p>}
        <div className="xyz">
  <label className="topTextEditAdmVehic2">Number of Partners:</label>
  <input
  className="inputSearchVehic"
    type="number"
    value={numPartners}
    onChange={(e) => handleNumPartnersChange(e)}
  />
</div>
{renderPartnerInputs()}
{errors.partners && <p className="error">⚠ {errors.partners}</p>}
<div className="xyz">
  <label className="topTextEditAdmVehic2">Number of Team Members:</label>
  <input
  className="inputSearchVehic"
    type="number"
    value={numTeamMembers}
    onChange={(e) => handleNumTeamMembersChange(e)}
  />
</div>
{renderTeamMemberInputs()}
{errors.teamMembers && <p className="error">⚠ {errors.teamMembers}</p>}
<div className="xyz">
  <label className="topTextEditAdmVehic2">Number of Documents:</label>
  <input
  className="inputSearchVehic"
    type="number"
    value={numDocs}
    onChange={(e) => handleNumDocChange(e)}
  />
</div>
{renderDocInputs()}
{errors.docs && <p className="error">⚠ {errors.docs}</p>}
        <button className="btnSearchVehicle hh" type="submit">Upload Project</button>
        {uploading && (
