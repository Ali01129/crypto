...
import PartnersTable from "../PartnersListing/PartnersTable";
  ...
  useEffect(() => {
    ...
    const fetchProjectsData = async () => {
      try {
        ...
        const response = await axios.get(`${SERVERURL}/api/v1/getPartnersAdminPanel`);
      ...
      <div className="topSideVehicles">
        ...
        <div className="vehicleAdminMain">
          <div className="topTextEditAdmVehic">
            You Can See & Edit Detail About Partners 
          </div>
          ...
          {!loading && (
            <div className="topTableAdminVehicles">
              <PartnersTable driverData={driversData} />
            </div>
          )}
        </div>
      </div>
