...
import AmbassadorsData from "../AmbassadorsData/AmbassadorsData";
...
const AmbassadorsAdmin = () => {
 ...
 // const [driversData2,setDriversData2] = useState([]);
      ...
      <div className="topSideVehicles">
        ...
        <div className="vehicleAdminMain">
          <div className="topTextEditAdmVehic">
            You Can See & Edit Detail About Ambassadors
          </div>
